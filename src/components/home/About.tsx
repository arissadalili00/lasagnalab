...
import { brand, brandImages, contactInfo } from "../../data/site";
    ...
    <SectionWrapper id="about" className="bg-cream">
      <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
        <ScrollReveal direction="right">
          <div className="relative overflow-hidden rounded-[2rem] premium-shadow-lg aspect-[4/3] sm:aspect-[5/4]">
            <img
              src={brandImages.aboutKitchen}
              alt="Fresh lasagna trays baked in jijah's kitchen"
              className="absolute inset-0 h-full w-full object-cover object-center scale-105"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-burgundy/75 via-burgundy/15 to-transparent" />
            <div className="absolute bottom-5 left-5 right-5 surface-card px-5 py-4">
              <p className="text-[11px] font-bold uppercase tracking-wider text-tomato">
                Our Kitchen
              </p>
        ...
        <div>
          ...
          <ScrollReveal delay={0.1}>
            <p className="text-lg text-tomato leading-relaxed mb-4 font-bold">
              {brand.byline}
            </p>
            ...
            <p className="text-ink/75 leading-relaxed mb-8 font-semibold">
              Every tray is baked fresh to order — never mass-produced.
              That&apos;s the creamy difference our customers keep coming back
              for.
            </p>
          </ScrollReveal>
